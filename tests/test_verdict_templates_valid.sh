...
AGENT_FILES="migration-engineer doc-writer dependency-auditor dependency-installer implementation-orchestrator requirements-orchestrator env-checker release-manager handoff-writer delivery-orchestrator"
