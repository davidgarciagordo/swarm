...
automations) desde [un único catálogo](https://github.com/davidgarciagordo/claude-plugins):
...
Para desarrollo local, apunta Claude Code directamente a tu checkout en su lugar:
